...
def train(appliance_name, model, mains, appliance, epochs, batch_size, threshold, pretrain,
    ...
    for epoch in range(epochs):
        ...
        if best_loss is None or loss_sum / cnt < best_loss:
            ...
            path_state_dict = "./" + appliance_name + "_gater_sgn_best_state_dict.pt"
            torch.save(net_state_dict, path_state_dict)

            checkpoint = {"model_state_dict": model.state_dict(),
                          "optimizer_state_dict": optimizer.state_dict(),
                          "epoch": epoch}
            path_checkpoint = "./" + appliance_name + "_gater_sgn_best_checkpoint.pt".format(
                epoch)
        ...
        if (checkpoint_interval != None) and ((epoch + 1) % checkpoint_interval == 0):
            checkpoint = {"model_state_dict": model.state_dict(),
                          "optimizer_state_dict": optimizer.state_dict(),
                          "epoch": epoch}
            path_checkpoint = "./" + appliance_name + "_gater_sgn_checkpoint_{}_epoch.pt".format(
                epoch)
            torch.save(checkpoint, path_checkpoint)
...
class GaterSGN(Disaggregator):

    def __init__(self, params):
        self.MODEL_NAME = "GaterSGN"
    ...
    def partial_fit(self, train_main, train_appliances, pretrain=False, do_preprocessing=True,
        ...
        print("...............Gater SGN partial_fit running...............")
    ...
    def disaggregate_chunk(self, test_main_list, model=None, do_preprocessing=True):
        ...
        for test_mains_df in test_main_list:
            ...
            for appliance in self.models:
                ...
                prediction = np.where(sum_arr > 0.5, 1000, 0)
