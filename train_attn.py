...
e = {
    ...
    'sample_rate': 3,
    'appliances': ['dish washer', 'washing machine', 'fridge'],
    ...
    'methods': {
        "AttentionCNN": AttentionCNN({
            'n_epochs': 100, 'note': USING_DATASET, 'sequence_length': 259, 'patience': 5
        }),
    },
    ...
    'test': {
        ...
        'metrics': ['accuracy', 'f1score', 'mae', 'sae', 'recall', 'precision', 'nep', 'MCC']
    }
}
